# Generated by Django 4.1.3 on 2022-11-14 05:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateDeNaissance', models.CharField(blank=True, max_length=50, null=True)),
                ('codePostalDeNaissance', models.CharField(blank=True, max_length=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idEmploye', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dashboard.employe')),
                ('idService', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dashboard.service')),
            ],
        ),
        migrations.CreateModel(
            name='Reponse',
            fields=[
                ...
                ('idQuestion', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dashboard.question')),
            ],
        ),
        migrations.CreateModel(
            name='Quiz',
        ...
        migrations.AddField(
            model_name='employe',
            name='idService',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dashboard.service'),
        ),
        migrations.CreateModel(
            name='Constituer',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idQuestion', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dashboard.question')),
                ('idReponse', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dashboard.reponse')),
            ],
        ),
        migrations.CreateModel(
            name='Composer',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idQuestion', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dashboard.question')),
                ('idQuiz', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='dashboard.quiz')),
            ],
        ),
    ]
